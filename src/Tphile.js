...
class Tphile extends Component {
  constructor(props) {
    super(props);
    this.state = {
      showOrderCard: false,
            ...
            <form className="form" onSubmit={this.Tripregister}>
              <div className="column">
                ...
                <div className="input-box">
                  ...
                  <input required="" placeholder="Enter destination place" type="text" id="RT2" defaultValue="Temple of philae" disabled />
                </div>
              </div>
              <div className="input-box">
