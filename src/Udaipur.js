...
class Udaipur extends Component {
  constructor(props) {
    super(props);
    this.state = {
      showOrderCard: false,
            ...
            <form className="form" onSubmit={this.Tripregister}>
              <div className="column">
                ...
                <div className="input-box">
                  ...
                  <input required="" placeholder="Enter destination place" type="text" id="RT2" defaultValue="Udaipur" disabled />
                </div>
              </div>
              <div className="input-box">
  ...
  <div className="input-box">
    ...
    <select required id="RT10" name="residency">
      ...
      <option value="Jagmandir Island Palace">Jagmandir Island Palace</option>
      <option value="The Lalit Laxmi Vilas Palace">The Lalit Laxmi Vilas Palace</option>
