...
class Indiagate extends Component {
  constructor(props) {
    super(props);
    this.state = {
      showOrderCard: false,
            ...
            <form className="form" onSubmit={this.Tripregister}>
              <div className="column">
                ...
                <div className="input-box">
                  ...
                  <input required="" placeholder="Enter destination place" type="text" id="RT2" defaultValue="Indian Gate" disabled />
                </div>
              </div>
              <div className="input-box">
  ...
  <div className="input-box">
    ...
    <select required id="RT10" name="residency">
      ...
      <option value="The Leela Palace New Delhi">The Leela Palace New Delhi</option>
      <option value="The Imperial New Delhi">The Imperial New Delhi</option>
      <option value="The Lalit New Delhi">The Lalit New Delhi</option>
