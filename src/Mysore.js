...
class Mysore extends Component {
  constructor(props) {
    super(props);
    this.state = {
      showOrderCard: false,
            ...
            <form className="form" onSubmit={this.Tripregister}>
              <div className="column">
                ...
                <div className="input-box">
                  ...
                  <input required="" placeholder="Enter destination place" type="text" id="RT2" defaultValue="Mysore Palace" disabled />
                </div>
              </div>
              <div className="input-box">
  ...
  <div className="input-box">
    ...
    <select required id="RT10" name="residency">
      ...
      <option value="The Ritz-Carlton Bangalore">The Ritz-Carlton Bangalore</option>
      <option value="Taj West End">Taj West End</option>
      <option value="The Leela Palace Bengaluru">The Leela Palace Bengaluru</option>
